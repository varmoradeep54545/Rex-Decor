...
const AboutUs = () => {
  return (
    <>
      <Navbar />
      <section className="flex justify-center py-16 px-6 md:px-20 ">
        <motion.div
          className="flex flex-col md:flex-row w-full max-w-6xl border border-gray-300 bg-white rounded-md shadow-lg overflow-hidden"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
