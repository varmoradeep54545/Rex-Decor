          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-left">
            ...
            <div>
              ...
              <div className="flex justify-center space-x-4">
                <a href="https://www.instagram.com/_patel_deep_1071_/" className="hover:text-gray-600">
                  <FaInstagram className="w-6 h-6" />
                </a>
                <a href="https://github.com/varmoradeep54545" className="hover:text-gray-600">
                  <FaGithub className="w-6 h-6" />
                </a>
              </div>
              <div className="flex justify-center space-x-4 mt-4">
                <a href="https://x.com/PatelMarks680" className="hover:text-gray-600">
                  <FaTwitter className="w-6 h-6" />
                </a>
                <a href="www.linkedin.com/in/varmora-deep-bb019a234" className="hover:text-gray-600">
